...
void drv_led_init(void) {
    ...
    GPIOD->AFR[1] |= (2 << 28);  // Set alternative function AF2 for PD12 (Alternative Funktion AF2 für PD12 setzen)

    // Konfiguriere PD12 (LED 4) für den alternativen Push-Pull-Modus
    //GPIOD->MODER |= GPIO_MODER_MODE15_1;  // Set alternative function (AF2) for PD12 (Alternative Funktion AF2 für PD12 setzen)
}
